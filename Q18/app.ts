...
let countries: string[] = ["Chaina","Dubai","Brazil","America","Egypt"];
...
console.log("Still in orignal order:",countries);
console.log("Orignal array reverse",countries.reverse());
console.log("Back to Orignal order:",countries.reverse());
console.log("Sorted alphabetical in order:",countries.sort());
console.log("Orignal array reverse again",countries.reverse());