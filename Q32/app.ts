...
let current_users = ["Saleem","Kishwer","Maham","Farees","Hareem"];
let new_users = ["Maham","Eshaal","Saman","Manahil","Hareem"];

new_users.forEach(new_one_user => {
    let our_condition = current_users.some(user_current_one => user_current_one.toLowerCase() === new_one_user.toLowerCase())
    if( our_condition){
