...
//. If the calling line includes a value for the number of tracks, add that value to 
//the album’s Object. Make at least one new function call that includes the number of
// tracks on an album.
