...
function make_shirt(size, message) {
    console.log("The selected size of the shirt is ".concat(size, " and the message printed on it is ").concat(message));
}
make_shirt("Medium", "I Love My Parents ");
make_shirt("Small", "Saman Kham");
